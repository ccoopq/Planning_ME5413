...
class PathTrackerNode
{
 ...
 private:
  ...
  Eigen::MatrixXd solveGain(double angle);

  // Compute LQR control
  Eigen::VectorXd computeLQRControl(const nav_msgs::Odometry& odom_robot, const geometry_msgs::Pose&   pose_goal);

  // Solve the discrete-time algebraic Riccati equation (DARE)
  Eigen::MatrixXd solveRiccatiEquation(const Eigen::MatrixXd& A, const Eigen::MatrixXd& B,
